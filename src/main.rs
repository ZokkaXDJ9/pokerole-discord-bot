...
async fn main() {
    ...
    let raw_rules = vec![
        GameRule {
            ...
            example: String::from("Let's say you want to use Rock Slide. The move has a -1 Accuracy effect. You roll your regular Dex+Rank amount of dies for your accuracy and land two successes. Now we reduce those successes by -1... which leaves us with one success, so the attack still hits, yay!")
        }, GameRule {
            ...
            example: String::from("With 4 points in Vitality and 5 points in Insight, you'd get 2 physical and 3 special defense!")
        }, GameRule {
            name: String::from("Orre Character Import"),
            flavor: String::from("Celebi did another woopsiedoodle!"),
